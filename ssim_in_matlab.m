...
us1_ssim_1 = ssim(GT/max(GT(:)),abs(recon_us1_ifft)/max(abs(recon_us1_ifft(:)))) ;
...
full_ssim_3 = ssim(uint16(GT),uint16(abs(recon_full_ifft))) ;
disp(['Full : ' , num2str(full_ssim_3)])

us1_ssim_3 = ssim(uint16(GT),uint16(abs(recon_us1_ifft))) ;
disp(['Undersampled 1 : ' , num2str(us1_ssim_3)])

us2_ssim_3 = ssim(uint16(GT),uint16(abs(recon_us2_ifft))) ;
disp(['Undersampled 2 : ' , num2str(us2_ssim_3)])

us3_ssim_3 = ssim(uint16(GT),uint16(abs(recon_us3_ifft))) ;
disp(['Undersampled 3 : ' , num2str(us3_ssim_3)])

[us4_ssim_3, S] = ssim(uint16(GT),uint16(abs(recon_us4_ifft))) ;
disp(['Undersampled 4 : ' , num2str(us4_ssim_3)])

[us4_ssim_3_m, S_m] = ssim(uint16(GT.*mask),uint16(abs(recon_us4_ifft).*mask)) ;
disp(['Undersampled 4 (masked) : ' , num2str(us4_ssim_3_m)])

disp('--------------------------------------------------')

save('data/ssim_matlab.mat','full_ssim_0','full_ssim_1','full_ssim_2','full_ssim_3', 'us1_ssim_0', 'us1_ssim_1', 'us1_ssim_2', 'us1_ssim_3', 'us2_ssim_0', 'us2_ssim_1', 'us2_ssim_2','us2_ssim_3','us3_ssim_0', 'us3_ssim_1', 'us3_ssim_2','us3_ssim_3','us4_ssim_0', 'us4_ssim_1', 'us4_ssim_2','us4_ssim_3','us4_ssim_3_m','S', 'S_m')